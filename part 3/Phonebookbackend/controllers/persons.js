// 路由处理程序也被移动到一个专用的模块中。 路由的事件处理程序通常称为*controllers*，出于这个原因，我们创建了一个新的*controllers* 目录。 所有与电话簿相关的路由现在都在*controllers* 目录下的*persons.js* 模块中定义
...
//part4 因为app.js中指定了主路径，此文件中的主路径可省略
//即'/persons'变为'/'
